...
public class QueryServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         out.println("<h2>Jelly Toy Search Results</h2>");

         if (!hasCategoryParam && !hasKeywordParam) { // No params present
            out.println("<h3 class=msg>Please select at least one category or enter a search term!</h3>");
            out.println("<p class=link><a href='start'>Back to Select Menu</a></p>");
         } else {
            ...
            if (!rset.next()) {
               out.println("<h3 class=msg>No toy found. Please try again!</h3>");
               out.println("<p class=link><a href='start'>Back to Select Menu</a></p>");
            } else {
               ...
               out.println("<th>IMAGE</th>"); // Column header for images
               ...
               do {
                  ...
                  out.println("<td><img src='" + rset.getString("image_url")
                        + "' alt='Toy Image' height='100' width='100'/></td>"); // Displaying the image
                  out.println("<td>$" + rset.getFloat("price") + "</td>");
